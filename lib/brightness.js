...
const debug = require('debug')('app:brightness');
...
const brightness = function (container, callback) {
  container.stats({ stream: false }, (err, stats) => {
    ...
    debug('Container: time %d, count %d', cpuTimeContainer, cpuCountContainer);
    debug('Total: time %d, count %d', cpuTimeTotal, cpuCountTotal);
    ...
    debug('Ratio: %d, Min: %d, Max: %d, Result: %d', ratio, min, max, result);
